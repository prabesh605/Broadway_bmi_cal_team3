...
class ApiTestSrceenWithBloc extends StatefulWidget {
  const ApiTestSrceenWithBloc({super.key});

  @override
  State<ApiTestSrceenWithBloc> createState() => _ApiTestSrceenWithBlocState();
}

class _ApiTestSrceenWithBlocState extends State<ApiTestSrceenWithBloc> {
  ...
  @override
  void initState() {
    context.read<TestApiBloc>().add(GetAllData());
    super.initState();
  }
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          //   child: Text("Get Data"),
          // ),
          BlocBuilder<TestApiBloc, TestApiState>(
