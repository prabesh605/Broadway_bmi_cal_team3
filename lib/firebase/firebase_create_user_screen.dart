...
class FirebaseCreateUserScreen extends StatelessWidget {
  const FirebaseCreateUserScreen({super.key});
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () async {
                UserCredential userCredential = await firbaseService.createUser(
