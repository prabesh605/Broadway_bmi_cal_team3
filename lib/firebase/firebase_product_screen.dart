...
class FirebaseProductScreen extends StatefulWidget {
  const FirebaseProductScreen({super.key});

  @override
  State<FirebaseProductScreen> createState() => _FirebaseProductScreenState();
}

class _FirebaseProductScreenState extends State<FirebaseProductScreen> {
